...
SYMBOLIC_LIB = {'x': (lambda x: x, lambda x: x, 1, lambda x, y_th: ((), x)),
                 ...
                 '1/x': (lambda x: 1/x, lambda x: 1/x, 3, f_inv),
                 '1/x^2': (lambda x: 1/x**2, lambda x: 1/x**2, 5, f_inv2),
                 '1/x^3': (lambda x: 1/x**3, lambda x: 1/x**3, 5, f_inv3),
                 ...
                 'x^1.5': (lambda x: torch.sqrt(x)**3, lambda x: sympy.sqrt(x)**3, 5, f_power1d5),
                 '1/sqrt(x)': (lambda x: 1/torch.sqrt(x), lambda x: 1/sympy.sqrt(x), 5, f_invsqrt),
                 '1/x^0.5': (lambda x: 1/torch.sqrt(x), lambda x: 1/sympy.sqrt(x), 5, f_invsqrt),
                 'exp': (lambda x: torch.exp(x), lambda x: sympy.exp(x), 2, f_exp),
                 'log': (lambda x: torch.log(x), lambda x: sympy.log(x), 2, f_log),
                 'abs': (lambda x: torch.abs(x), lambda x: sympy.Abs(x), 2, lambda x, y_th: ((), torch.abs(x))),
                 ...
                 'tanh': (lambda x: torch.tanh(x), lambda x: sympy.tanh(x), 2, lambda x, y_th: ((), torch.tanh(x))),
                 'sgn': (lambda x: torch.sign(x), lambda x: sympy.sign(x), 2, lambda x, y_th: ((), torch.sign(x))),
                 ...
                 'arctan': (lambda x: torch.arctan(x), lambda x: sympy.atan(x), 2, lambda x, y_th: ((), torch.arctan(x))),
                 #'arctanh': (lambda x: torch.arctanh(x), lambda x: sympy.atanh(x), 4, f_arctanh),
                 '0': (lambda x: x*0, lambda x: x*0, 1, lambda x, y_th: ((), x*0)),
                 'gaussian': (lambda x: torch.exp(-x**2), lambda x: sympy.exp(-x**2), 6, lambda x, y_th: ((), torch.exp(-x**2))),
                 'cosh': (lambda x: torch.cosh(x), lambda x: sympy.cosh(x), 2, lambda x, y_th: ((), torch.cosh(x))),
                 'sigmoid': (lambda x: torch.sigmoid(x), sympy.Function('sigmoid'), 2, lambda x, y_th: ((), torch.sigmoid(x))),
